...
The `Zeigler` folder contains 33 publicly available Zeigler Award lectures published in JSM. Each lecture is available in PDF, Markdown, and JSON formats to facilitate verification, preprocessing, and NLP analysis. Please note that **Dr. Damon Andrew's lecture** has not yet been published in JSM; his speech, delivered at this year's (2025) award reception, was transcribed and included for analysis.
